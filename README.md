...
This document describes *radex_pipeline.py*, which is the first step needed for our multi-line modeling. The further steps using other scripts are described in [_../multiline-bayesian-modeling_

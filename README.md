...
This document describes *radex_pipeline.py*, which is the first step needed for our multi-line modeling. The following analysis workflow is described in [_../multiline-bayesian-modeling_

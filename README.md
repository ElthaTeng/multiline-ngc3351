...
This document describes *radex_pipeline.py*, which is the first step needed for our multi-line modeling. The following analysis workflow is described in [*../multiline-bayesian-modeling
